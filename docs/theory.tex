...
$A_r$, $r\ge 1$ &
  $\underset{1}{\circ}\!-\!\underset{2}{\circ}\!-\!\cdots\!-\!\underset{r-1}{\circ}\!-\!\underset{r}{\circ}$ \\[1.1em]
$B_r$, $r\ge 2$ &
  $\underset{1}{\circ}\!-\!\underset{2}{\circ}\!-\!\cdots\!-\!\underset{r-1}{\circ}\Rightarrow\underset{r}{\circ}$ \\[1.1em]
$C_r$, $r\ge 3$ &
  $\underset{1}{\circ}\!-\!\underset{2}{\circ}\!-\!\cdots\!-\!\underset{r-1}{\circ}\Leftarrow\underset{r}{\circ}$ \\[1.1em]
$G_2$ &
  $\underset{1}{\circ}\Rrightarrow\underset{2}{\circ}$ \\[1.1em]
$F_4$ &
  $\underset{1}{\circ}\!-\!\underset{2}{\circ}\Rightarrow\underset{3}{\circ}\!-\!\underset{4}{\circ}$ \\
\end{tabular}
...
\[
  \begin{array}{ccccccc}
    &&&&& \underset{r-1}{\circ} \\[-0.15em]
    &&&& \diagup && \\[-0.35em]
    \underset{1}{\circ} & \!-\! & \cdots & \!-\! & \underset{r-2}{\circ} && \\[-0.35em]
    &&&& \diagdown && \\[-0.15em]
    &&&&& \underset{r}{\circ}
  \end{array}
\]
...
\[
  \begin{array}{ccccccccccccc}
    &&&& \overset{2}{\circ} &&&&&&&& \\[-0.4em]
    &&&& | &&&&&&&& \\[-0.2em]
    \underset{1}{\circ} & \!-\! & \underset{3}{\circ} & \!-\! & \underset{4}{\circ} & \!-\! &
    \underset{5}{\circ} & \!-\! & \underset{6}{\circ} & \!-\! & \underset{7}{\circ} & \!-\! &
    \underset{8}{\circ}
  \end{array}
\]
