...
pub enum BcdError {
    ...
    /// this module implements, passed to [`Irrep::from_dynkin_in`].
    ...
    /// through [`Irrep::from_dynkin_in`] with `GroupId::spin(N)`.
    SpinorLabel {
        /// The series.
        series: Series,
        /// The offending Dynkin label.
...
impl Irrep {
    ...
    /// [`two_rho_vee`]. Consequences per family:
    ///
