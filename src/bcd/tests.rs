...
/// Independent-implementation oracle (issue #19 item 5): checks every record in
/// `tests/fixtures/bcd_fixtures.json` — dims and full tensor-product
/// decompositions from an external exact implementation — against this crate's
/// own `directproduct`. The committed fixture was generated by
/// `tools/gen_bcd_fixtures.jl` (Oscar 1.8.0); `tools/gen_bcd_fixtures.py`
/// (SageMath) is an equivalent generator. Regenerate either with its script;
/// values are never hand-written.
#[test]
